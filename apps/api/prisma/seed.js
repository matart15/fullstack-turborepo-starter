...
var a = require("../src/modules/users/users.service");
console.log('a: ', a);
var UsersService = a.UsersService;
var prisma = new client_1.PrismaClient();
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var prismaService, usersService;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('💫 seed executing ...');
                prismaService = new nestjs_prisma_1.PrismaService();
